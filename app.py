...
def generate_dataset(nbr):
    face_classifier = cv2.CascadeClassifier(
        "/Users/nhathuy/PycharmProjects/flaskface/resources/haarcascade_frontalface_default.xml")
...
def train_classifier(nbr):
    dataset_dir = "/Users/nhathuy/PycharmProjects/flaskface/dataset"
    ...
    clf.train(faces, ids)
    clf.write("/Users/nhathuy/PycharmProjects/flaskface/classifier.xml")
...
def face_recognition():  # generate frame by frame from camera
    ...
    faceCascade = cv2.CascadeClassifier( "/Users/nhathuy/PycharmProjects/flaskface/resources/haarcascade_frontalface_default.xml")
    clf = cv2.face.LBPHFaceRecognizer_create()
    clf.read("/Users/nhathuy/PycharmProjects/flaskface/classifier.xml")
